...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="user_login_process">
      ...
      <li class="nav-item active">
        <a class="nav-link" href='<?php echo base_url("/user/dashboard/upload_project");?>'>
